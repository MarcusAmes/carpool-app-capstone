...
import { Col, Button, Form, FormGroup, Label, Input, Row, Container, ModalHeader, ModalFooter } from 'reactstrap';
...
class NewBusinessForm extends Component {
  ...
  render() {
    ...
    return (
      <>
        <ModalHeader toggle={this.toggle}>Add a new Business.</ModalHeader>
        <Container style={{ marginTop: "1%" }}>
          <Form onSubmit={this._onSubmit}>
            ...
            <ModalFooter>
              <Button color="success">Add New Business</Button>
              <Button color="secondary" onClick={this.props.back}>Back</Button>
            </ModalFooter>
          </Form>
        </Container>
      </>
